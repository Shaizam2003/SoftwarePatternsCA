...
public class ManagerRecord {
		...
		public ManagerRecord(EmployeeDetails employeeDetails) {
		...
		// display current Employee details
			public void displayRecords(Employee thisEmployee) {
				...
				if (thisEmployee == null) {
					...
					employeeDetails.idTextField.setText(Integer.toString(thisEmployee.getEmployeeId()));
					employeeDetails.ppsTextField.setText(thisEmployee.getPps().trim());
					employeeDetails.surnameTextField.setText(thisEmployee.getSurname().trim());
					employeeDetails.firstNameTextField.setText(thisEmployee.getFirstName());
					employeeDetails.genderComboBox.setSelectedIndex(countGender);
					employeeDetails.departmentComboBox.setSelectedIndex(countDep);
					employeeDetails.salaryTextField.setText(employeeDetails.format.format(thisEmployee.getSalary()));
					// set corresponding full time combo box value to current employee
					if (thisEmployee.getFullTime() == true)
						employeeDetails.fullTimeComboBox.setSelectedIndex(1);
					else
						employeeDetails.fullTimeComboBox.setSelectedIndex(2);
				}
