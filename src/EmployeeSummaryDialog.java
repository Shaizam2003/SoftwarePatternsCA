...
public class EmployeeSummaryDialog extends JDialog implements ActionListener {
	...
	public EmployeeSummaryDialog(EmployeeDetails parent, Vector<Object> allEmployees) {
		super(parent);
	...
	public Container summaryPane() {
		...
		for (Object employee : allEmployees) {
			tableModel.addRow((Vector<?>) employee);
		}
		employeeTable.setEnabled(false);
		employeeTable.setPreferredScrollableViewportSize(
				new Dimension(800, (15 * employeeTable.getRowCount() + 15)));
